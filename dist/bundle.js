...
module.exports = __webpack_require__(/*! /Users/jordancenter/Documents/Code/GithubGameOff2017/src/main.js */332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__(/*! ../config */ 128);
/* globals __DEV__ */
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    ...
    game.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.RIGHT);
    ...
    // BLOCK
    this.block = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite(this.game, __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.x - 280, __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.y, 'block');
    ...
    this.ground = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite(this.game, this.game.world.centerX, this.game.world.centerY + 308, 'ground');
  ...
  update() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].update();

    this.block.angle = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.rotate;
    // this.block.x = -275
    // this.block.y = 0
    this.block.x = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.x;
    this.block.y = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.y;

    // handle player direction
    if (game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.LEFT)) {
      __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].player.direction = -1;
    } else if (game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.RIGHT)) {
      __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].player.direction = 1;
    }
    ...
    if (game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.RIGHT)) {
      ...
      if (this.playerIsOnGround && __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].player.direction == 1) {
    ...
    // jump input
    if (game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.UP) && hitPlatform) {
      this.player.body.velocity.y = -250;
    }

    if (game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.UP) && hitBlock) {
      this.player.body.velocity.y = -250;
    }

    // determins player direction
    if (!hitPlatform) {
      if (__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].player.direction == 1) {
        this.player.frame = 1;
      } else {
        this.player.frame = 8;
      }
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].window.min <= 1) {
      __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].press = false;
    } else if (__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].window.min > 1) {
      __WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].press = true;
    }
  }

  render() {
    if (true) {
      this.game.debug.text('Player.position: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].player.position), 32, 32);
      this.game.debug.text('Window.min: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].window.min), 32, 47);
      this.game.debug.text('Window.max: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].window.max), 32, 62);

      this.game.debug.text('Block.position: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.position), 382, 32);
      this.game.debug.text('Block.angle: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.angle), 382, 47);
      this.game.debug.text('Block.x: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.x), 382, 62);
      this.game.debug.text('Block.y: ' + JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */].block.y), 382, 77);
